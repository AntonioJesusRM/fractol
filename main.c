...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/28 11:36:20 by aruiz-mo          #+#    #+#             */
/*   Updated: 2022/09/01 16:39:57 by aruiz-mo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_color(int iter, int palette)
{
	...
	int			g;
	int			b;
	static int	map[][3] = {{0, 7, 100}, {12, 44, 138}, {24, 82, 177},
	{57, 125, 209}, {66, 30, 15}, {25, 7, 26}, {9, 1, 47}, {4, 4, 73},
...
void	inicializate_args(int ac, char **av, t_vars *vars)
{
	if (ac == 1 || (av[1][0] != '1' && av[1][0] != '2'))
	{
